 ...
 * Generated for Laravel 5.5.18 on 2017-10-29.
 *
...
namespace Anhskohbo\NoCaptcha\Facades { 
    ...
    class NoCaptcha {
         ...
         * @static 
         */ 
        public static function display($attributes = array(), $lang = null)
        {
            return \Anhskohbo\NoCaptcha\NoCaptcha::display($attributes, $lang);
        }
         ...
         * @static 
         */ 
        public static function getJsLink($lang = null)
        {
            return \Anhskohbo\NoCaptcha\NoCaptcha::getJsLink($lang);
        }
