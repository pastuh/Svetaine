...
class PermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->permission_type == 'basic'){
            ...
            $this->validate($request, [
                ...
                'slug' => 'required|max:100|alpha_dash|unique:permissions,name',
            ...
            Session::flash('success', 'Leidimas sėkmingai išsaugotas!');
            ...
            if(count($crud) > 0 ){
                ...
                Session::flash('success', 'Leidimai sėkmingai išsaugoti!');
                return redirect()->route('permissions.index');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('success', 'Leidimas ' . $permission->display_name . ' išsaugotas!');
