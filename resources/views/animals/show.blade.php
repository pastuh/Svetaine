...
@section('content')
    ...
    <div id="fullpage" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="fix-padding col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                                ...
                                <div class="block__location">
                                    <p class="block__location-text">{{ $animal->lt_title }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="section" id="section1">
            <div class="fp-bg"
                 style='background-image: url("{{ url('../img/animals/' . $animal->info_image) }}"); background-size: cover; background-position: top center; height: 100%; display: flex; justify-content: center; align-items: center;'>
    ...
    {{--Įrašo sunaikinimo forma--}}
    <form id="main-form" class="hidden" method="POST" action="{{ route('animals.destroy', $animal->id) }}">
        {{ method_field('DELETE') }}
        {{ csrf_field() }}
    </form>
@endsection
