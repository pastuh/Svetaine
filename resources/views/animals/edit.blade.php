...
@section('title', '| ' . htmlspecialchars($animal->title) . " trofėjaus redagavimas")
                                        ...
                                        <div class="{{ $errors->has('title') ? ' has-error' : '' }}">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input id="title" type="text" class="form-control" name="title"
                                                       ...
                                                       value="{{ old('title', $animal->title) }}" required autofocus
                                        ...
                                        <div class="{{ $errors->has('lt_title') ? ' has-error' : '' }}">
                                            <div class="input-group input-group-lg">
                                                ...
                                                <input type="text" class="form-control" name="lt_title"
                                                       ...
                                                       value="{{ old('lt_title', $animal->lt_title) }}" required
                                                       minlength="2" maxlength="90">
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="{{ $errors->has('body') ? ' has-error' : '' }}">
                                                <textarea id="body" class="form-control" name="body" rows="5"
                                                          cols="45">{{ old('body', $animal->body) }}</textarea>
                                                @if ($errors->has('body'))
                                                    <span class="help-block">
                                                    {{ $errors->first('body') }}
                                                    </span>
                                            ...
                                            <div class="{{ $errors->has('bg_position') ? ' has-error' : '' }}">
                                                ...
                                                <span class="input-group-addon" id="basic-addon1"><span
                                                    ...
                                                    <input type="text" class="form-control" name="bg_position"
                                                           ...
                                                           value="{{ old('bg_position', $animal->bg_position) }}" required
                                        ...
                                        <div class="col-xs-12 control-margin" style="margin-top: 10px;">
                                            <label class="control control-checkbox">
                                                ...
                                                <input id="status_check" type="checkbox" name="status_check"
                                                       value="true" {{ $animal->status ? 'checked' : '' }} />
                                            ...
                                            @if(Auth::user()->hasRole('editor|administrator|superadministrator'))
                                                <label class="control control-checkbox">
                                                    ...
                                                    <input id="published_check" type="checkbox" name="published_check"
                                                           value="true" {{ $animal->published ? 'checked' : '' }} />
                                                    <div class="control_indicator"></div>
                                                </label>
                                            @endif
                                        </div>
